...
for v in WHATSAPP_PROVIDER WHATSAPP_NUMBER WHATSAPP_COUNTRY_CODE \
         ...
         WHATSAPP_TEMPLATE_CAR_READY WHATSAPP_TEMPLATE_CHECKED_IN WHATSAPP_TEMPLATE_ON_THE_WAY WHATSAPP_TEMPLATE_REQUESTED WHATSAPP_DEBUG_INBOUND ANPR_SERVICE_URL FACE_RECOGNITION_URL; do
  if [ -n "${!v:-}" ]; then
