    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <table className="min-w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="px-4 py-3 text-left text-xs font-medium text-gray-400 uppercase tracking-wider">Gate</th>
                ...
                {recentEvents.length === 0 ? (
                  ...
                  recentEvents.map((event) => (
                    <tr key={event.id} className="hover:bg-gray-50 transition-all duration-300">
                      ...
                      <td className="px-4 py-3 text-sm font-mono text-gray-900">{event.plate}</td>
        ...
        <div className="glass-panel">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Gate Status</h2>
          </div>
          <div className="p-4 space-y-3">
            {gates.length === 0 ? (
              ...
              gates.map((gate) => (
                <div
                  key={gate.id}
                  className="flex items-center justify-between p-3 bg-gray-50 rounded-xl border border-gray-200 transition-all duration-300 hover:bg-gray-50"
                >
