  ...
  return (
    <div className="space-y-6">
      ...
      <div className="glass-panel p-6">
        <h2 className="text-lg font-semibold text-slate-100 mb-4">Daily Report</h2>
        <div className="flex flex-wrap items-end gap-4">
          ...
          {downloadUrl && (
            <a
              ...
              className="px-6 py-2 text-sm font-medium text-glow-blue hover:text-glow-purple glass-panel border border-surface-border rounded-xl transition-all duration-300 hover:shadow-[0_0_20px_rgba(99,102,241,0.15)]"
            >
              Download PDF
            </a>
          )}
