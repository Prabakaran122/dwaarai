...
const communityNav = [
  ...
  { href: '/activity', label: 'Live Activity', icon: 'M13 10V3L4 14h7v7l9-11h-7z' },
...
const superAdminNav = [
  { href: '/onboarding', label: 'New property', icon: 'M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z' },
  { href: '/accounts', label: 'Accounts', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
