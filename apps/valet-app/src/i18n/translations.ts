// DwaarAI Valet i18n — English / Hindi / Kannada.
...
export const translations: Dict = {
  ...
  valetSlot: { en: 'Parking slot', hi: 'पार्किंग स्लॉट', kn: 'ಪಾರ್ಕಿಂಗ್ ಸ್ಲಾಟ್' },
  valetSlotSkip: { en: 'No slot — parking elsewhere', hi: 'कोई स्लॉट नहीं', kn: 'ಸ್ಲಾಟ್ ಇಲ್ಲ' },
  valetSlotFull: { en: 'No free slots. Take the car in anyway.', hi: 'कोई खाली स्लॉट नहीं। फिर भी गाड़ी लें।', kn: 'ಖಾಲಿ ಸ್ಲಾಟ್ ಇಲ್ಲ. ಹಾಗಿದ್ದರೂ ಕಾರು ತೆಗೆದುಕೊಳ್ಳಿ.' },
  valetPhone: { en: 'Guest mobile (optional)', hi: 'अतिथि मोबाइल (वैकल्पिक)', kn: 'ಅತಿಥಿ ಮೊಬೈಲ್ (ಐಚ್ಛಿಕ)' },
  valetPhoneHint: { en: 'With their permission — we text them the code', hi: 'उनकी अनुमति से — हम उन्हें कोड भेजेंगे', kn: 'ಅವರ ಅನುಮತಿಯೊಂದಿಗೆ — ನಾವು ಕೋಡ್ ಕಳುಹಿಸುತ್ತೇವೆ' },
  valetSmsSent: { en: 'Code texted to the guest', hi: 'कोड अतिथि को भेजा गया', kn: 'ಕೋಡ್ ಅತಿಥಿಗೆ ಕಳುಹಿಸಲಾಗಿದೆ' },
  valetSmsFailed: { en: 'Text did not send — read the code out', hi: 'संदेश नहीं गया — कोड पढ़कर बताएं', kn: 'ಸಂದೇಶ ಹೋಗಿಲ್ಲ — ಕೋಡ್ ಓದಿ ಹೇಳಿ' },
  valetPhoneInvalid: { en: 'Enter a valid 10-digit mobile number', hi: 'मान्य 10 अंकों का मोबाइल नंबर डालें', kn: 'ಮಾನ್ಯ 10 ಅಂಕಿಯ ಮೊಬೈಲ್ ಸಂಖ್ಯೆ ನಮೂದಿಸಿ' },
  ...
  valetCameraBlocked: { en: 'Camera is blocked for DwaarAI Valet. Turn it on in Settings.', hi: 'DwaarAI Valet के लिए कैमरा बंद है। सेटिंग्स में चालू करें।', kn: 'DwaarAI Valetಗೆ ಕ್ಯಾಮೆರಾ ನಿರ್ಬಂಧಿಸಲಾಗಿದೆ. ಸೆಟ್ಟಿಂಗ್‌ಗಳಲ್ಲಿ ಆನ್ ಮಾಡಿ.' },
